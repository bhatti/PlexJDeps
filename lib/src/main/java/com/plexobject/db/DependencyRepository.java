...
public class DependencyRepository {
    ...
    public DependencyRepository(EntityStore entityStore, final DatabaseStore databaseStore, final RepositoryFactory repositoryFactory) throws DatabaseException {
